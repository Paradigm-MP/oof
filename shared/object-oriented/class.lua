    ...
    setmetatable(cls, {__call = function (c, ...)
        ...
        if init then
            ...
            if __collect_inits then
                table.insert(__immediate_list, {instance, generate_init_function(instance, args)})
            elseif init then
...
function load_first_class()
    ...
    setmetatable(cls, {__call = function (c, ...)
        ...
        if __collect_inits then
            ...
            if instance.__loadFirst then
                table.insert(__load_first, {instance, function() instance.__loadFirst(instance) end})
            end
        else
            if init then
                generate_init_function(instance, args)()
